...
export function SigningTest() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-2 px-4 py-3 bg-red-50 border border-red-100 rounded-lg">
          ...
          <div>
            ...
            <p className="text-sm text-red-700 mt-0.5">
              {error || signError?.message || typedDataError?.message}
            </p>
          </div>
        </div>
      )}
      ...
      {/* Success Result */}
      {(isMessageSuccess || isTypedDataSuccess) &&
          ...
          <div className="space-y-3">
            <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
              ...
              <p className="text-xs text-gray-700 font-mono break-all">
                {mode === 'message' ? messageSignature : typedDataSignature}
              </p>
            </div>
          </div>
        )}
