/**
 * Test-only bridge between the low-level backend e2e client/session and the
 ...
 *
 * parseSession() omits `stamperType`, and the backend e2e client's
...
/**
 * Wraps the backend e2e client + parsed session into the minimal wallet shape
