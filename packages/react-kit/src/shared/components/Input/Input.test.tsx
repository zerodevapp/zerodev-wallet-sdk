...
describe('Input', () => {
  ...
  describe('variants', () => {
    it('wraps in a Wrapper for the default variant', () => {
      ...
      // The Wrapper renders a div with backdrop-blur-md
      const wrapper = container.querySelector('.backdrop-blur-md')
    ...
    it('wraps in a Wrapper for the listItemStyle variant', () => {
      const { container } = render(
        <Input variant="listItemStyle" placeholder="List" />,
      )
      const wrapper = container.querySelector('.backdrop-blur-md')
      expect(wrapper).not.toBeNull()
    })
  ...
  describe('height classes', () => {
    ...
    it('applies h-32 for multiline', () => {
      const { container } = render(<Input multiline placeholder="Multi" />)
      const wrapper = container.querySelector('.backdrop-blur-md')
    ...
    it('applies h-[68px] for listItemStyle', () => {
      ...
      const wrapper = container.querySelector('.backdrop-blur-md')
      expect(wrapper?.className).toContain('h-[68px]')
    })
  })

  describe('focus behavior', () => {
    it('changes Wrapper variant to solid on focus', () => {
